  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <ProgressRing
            ...
            color="#10B981"
          />
          <ProgressRing percentage={89} value="89%" label="On-Time Doses" color="#3B82F6" />
          <ProgressRing percentage={40} value="12/30" label="Streak Progress" color="#F97316" />
          <ProgressRing percentage={75} value="3/4" label="Active Medications" color="#8B5CF6" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <AdherenceChart data={adherenceData} timeRange={timeRange} />
        </div>

        {/* Trend Chart */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <TrendChart data={trendData} title="Adherence Trend" color="#F97316" />
        </div>
      </div>

      {/* Medication Breakdown */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <MedicationBreakdown medications={medicationBreakdown} />
      </div>

      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        {/* Calendar Heatmap */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <HeatmapCalendar data={calendarData} year={2024} month={1} />
        </div>
